        ...
        <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
            <div
              ...
              style={{ fontSize: "22px", color: "white", cursor: "pointer", display: "none", marginTop: "4px" }}
            >
              {mobileMenuOpen ? <FaTimes /> : <FaBars />}
            </div>

            <Link to="/" style={logoStyle}>
              <span style={{ fontWeight: "800", fontSize: "20px", background: "linear-gradient(to right, #fff, #dadada)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", lineHeight: 1 }}>MEKARO.</span>
            </Link>
          </div>

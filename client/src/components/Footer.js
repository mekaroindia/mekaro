...
import { FaInstagram, FaLinkedin, FaYoutube, FaChevronDown, FaChevronUp } from "react-icons/fa";
...
export default function Footer({ hideOnMobile }) {
  ...
  return (
    <footer className={`footer ${hideOnMobile ? 'hide-on-mobile' : ''}`}>
      <div className="footer-container">
        ...
        <div className="footer-col brand-col">
          ...
          <div className="social-icons">
            <a href="https://www.instagram.com/mekaro.india/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <FaInstagram className="social-icon" />
            </a>
            <a href="https://www.youtube.com/channel/UCErg7lS9-M7jEeUR-k-qilA" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              <FaYoutube className="social-icon" />
            </a>
            <a href="https://www.linkedin.com/company/mekaro-india/" target="_blank" rel="noopener noreferrer" aria-label="Linkedin">

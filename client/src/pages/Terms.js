...
const Terms = () => {
    const sections = [
        {
            title: "OVERVIEW",
            content: `This website is operated by Mekaro. Throughout the site, the terms “we”, “us” and “our” refer to Mekaro. Mekaro offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.

By visiting our site and/or purchasing something from us, you engage in our “Service” and agree to be bound by the following terms and conditions (“Terms of Service”, “Terms”), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service applies to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/ or contributors of content.

Please read these Terms of Service carefully before accessing or using our website. By accessing or using any part of the site, you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions of this agreement, then you may not access the website or use any services. If these Terms of Service are considered an offer, acceptance is expressly limited to these Terms of Service.`
        },
        {
            title: "SECTION 1 - ONLINE STORE TERMS",
            content: `By agreeing to these Terms of Service, you represent that you are at least or that you are the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site.
...
We reserve the right at any time to modify or discontinue any Service or Offers (or any part or content thereof), without prior notice at any time.

We shall not be liable to you or to any third-party for any modification, price change, suspension or discontinuance of the Service.`
        },
        {
            title: "SECTION 5 - PRODUCTS OR SERVICES",
            content: `Certain products or services may be available exclusively online through our website. These products or services may have limited quantities and are subject to return or exchange only according to our Return Policy.
...
You agree to provide current, complete and accurate purchase and account information for all purchases made at our store. You agree to promptly update your account and other information, including your email address and credit card numbers and expiration dates, so that we can complete your transactions and contact you as needed.`
        },
        {
            ...
            content: `We may provide you with access to third-party tools over which we neither have any controls or input nor we monitor.
...
We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes.`
        },
        {
            ...
            content: `Questions about the Terms of Service should be sent to us at mekaro.india@gmail.com.`
        }
    ];
        ...
        <div className="terms-page">
            ...
            <style>{`
                ...
                @media (max-width: 768px) {
                    .terms-container { padding: 30px 0; }
                    .terms-title { font-size: 28px; margin-bottom: 30px; }
                    .terms-section { padding: 20px; border-radius: 16px; }

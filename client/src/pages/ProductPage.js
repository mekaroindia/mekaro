...
export default function ProductPage() {
  ...
  const handleReviewSubmit = async (e) => {
    ...
    try {
      ...
      fetchProductAndReviews(); // Re-fetch all data to get updated averages and new review list
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="product-page">
          ...
          <div className="product-layout">
            ...
            <div className="details-section">
              ...
              <div className="price-rating-row">
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <span style={{
                    ...
                    ₹{calculateFakeOriginalPrice(product.price, product.id).toLocaleString()}
                  </span>
                  ...
                  <div className="stars">
                    {product.average_rating > 0 ? (
                      <Rating
                        ...
                        readonly
                        emptySymbol={<FaStar className="star-faded" />}
                        fullSymbol={<FaStar />}
                        fractions={2}
                      />
                    ) : (
              ...
              <div className="features-row">
                ...
                <div className="feature-item"><FaTruck className="icon" /> 1 Day Return</div>
              </div>
                  ...
                  {reviews.length > 0 ? (
                    reviews.map(review => (
                      <div key={review.id} className="review-card">
                        ...
                        <p>"{review.comment}"</p>
                        <small style={{ color: '#64748b', fontSize: '0.8rem' }}>{new Date(review.created_at).toLocaleDateString()}</small>
                      </div>
                    ))
                  ) : (
                  ...
                  <div className="write-review-section">
                    ...
                    <form onSubmit={handleReviewSubmit} className="review-form">
                      <div className="review-form-group">
                        ...
                        <Rating
                          emptySymbol={<FaStar className="star-faded" style={{ fontSize: '1.5rem' }} />}
                          fullSymbol={<FaStar style={{ fontSize: '1.5rem' }} />}
                ...
                {relatedProducts.map((p) => (
                  ...
                  >
                    ...
                    <div className="related-info">
                      ...
                      <div className="related-price-row" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{
                          fontSize: '12px',
                          color: '#64748b',
                          textDecoration: 'line-through'
                        }}>
                          ₹{calculateFakeOriginalPrice(p.price, p.id).toLocaleString()}
                        </span>
      ...
      <style>{`
        ...
        .review-card p { font-style: italic; color: #cbd5e1; margin: 0 0 10px 0; }

        .write-review-section { margin-top: 40px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 20px;}
        .write-review-section h4 { font-size: 1.2rem; color: #fff; margin-bottom: 20px; }
        .review-form { display: flex; flex-direction: column; gap: 20px; max-width: 600px; }
        .review-form-group { display: flex; flex-direction: column; gap: 8px; }
        .review-form-group label { color: #94a3b8; font-size: 0.95rem; font-weight: 500; }
        .review-textarea { 
          background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(255,255,255,0.1); 
          color: white; padding: 15px; border-radius: 10px; font-family: inherit; resize: vertical; 
        }
        ...
        .submit-review-btn:hover { transform: translateY(-2px); box-shadow: 0 4px 15px rgba(6, 182, 212, 0.3); }
        .submit-review-btn:disabled { opacity: 0.7; cursor: not-allowed; transform: none; box-shadow: none; }
